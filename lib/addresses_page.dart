...
class _AddressesPageState extends State<AddressesPage> {
                                      ...
                                      TextButton.icon(
                                        onPressed: () async {
                                          ...
                                          try {
                                            ...
                                            for (final prevDoc
                                                in prevDefaults.docs) {
                                              await prevDoc.reference.update({
                                                'isDefault': false,
                                              });
                                            }
  ...
  void _showAddressDialog(
    ...
    bool isDefault =
        data?['isDefault'] ?? (id == null); // Default to true for new addresses
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CheckboxListTile(
                      value: isDefault,
                      onChanged:
                          (val) => setState(() => isDefault = val ?? false),
                      title: const Text(
                        'Set as default shipping address',
                        style: TextStyle(fontWeight: FontWeight.w500),
                      ),
                      subtitle: const Text(
                        'This will be selected by default at checkout',
                      ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text(
                          id == null ? 'ADD ADDRESS' : 'SAVE CHANGES',
                        ),
                      ),
                    ),
                    const SizedBox(height: 24),
