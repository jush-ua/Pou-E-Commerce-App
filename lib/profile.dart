...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        primaryColor: const Color(0xFFE47F43),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildFeatureItem(Icons.search, "Browse"),
                    _buildFeatureItem(
                      Icons.shopping_cart_outlined,
                      "View Cart",
                    ),
                    _buildFeatureItem(Icons.favorite_border, "Wishlist"),
                  ],
                ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color(0xFFE47F43),
